    ...
    <footer className="bg-[#0a1535] text-white" dir="rtl">
          ...
          <div className="text-right">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <span>יגאל אלון 94, קומה 31 תל אביב</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
                <Clock size={18} className="text-[#c9a84c]" />
                <span>שעות פעילות | 09:00 - 19:00</span>
              </div>
              <a
                href="mailto:office@shemer-mortgage.co.il"
                className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors"
              >
                <Mail size={18} className="text-[#c9a84c]" />
                <span>office@shemer-mortgage.co.il</span>
              </a>
            </div>
          </div>
          ...
          <div className="text-right">
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <span className="group-hover:text-white">רוסלן שמר</span>
              </a>
              <a
              ...
              >
                ...
                <span className="group-hover:text-white">@ros.shemer</span>
              </a>
              <a
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col items-center gap-4">
          ...
          <p
            className="text-gray-500 text-sm mt-2 inline-flex flex-wrap items-center justify-center gap-1.5"
            dir="ltr"
          >
